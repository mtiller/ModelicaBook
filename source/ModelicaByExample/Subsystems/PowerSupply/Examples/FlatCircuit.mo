...
model FlatCircuit
  "A model with power source, AC-DC conversion and load in one diagram"
  ...
  Modelica.Electrical.Analog.Ideal.IdealDiode D1(Vknee=0)
                                                         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=45,
        origin={-12,20})));
  Modelica.Electrical.Analog.Basic.Capacitor capacitor(C=1e-2)
                                                       annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
  ...
  Modelica.Electrical.Analog.Ideal.IdealDiode D2(Vknee=0)
                                                         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=-45,
        origin={12,20})));
  Modelica.Electrical.Analog.Ideal.IdealDiode D3(Vknee=0)
                                                         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=-45,
        origin={-12,0})));
  Modelica.Electrical.Analog.Ideal.IdealDiode D4(Vknee=0)
                                                         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=45,
...
equation
  ...
  connect(D1.n, D2.p) annotation (Line(
      points={{-4.92893,27.0711},{2.18813e-006,28},{4.92893,28},{4.92893,
          27.0711}},
      color={0,0,255},
      smooth=Smooth.None));
