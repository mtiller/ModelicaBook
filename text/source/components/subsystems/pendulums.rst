...
In this section, we will recreate an interesting experiment involving
pendulums.  If we create a series of pendulums with different natural
frequencies and then start them all at the same position, what we will
see is that they will oscillate at different frequencies.  But if we
remove any energy dissipation from the system, they will eventually
...
of pendulums.  If we want a system of :ref:`n` pendulums where the
period for a complete cycle of the system is :ref:`T` seconds, we
